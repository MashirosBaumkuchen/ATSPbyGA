...
for i=1:20
    ...
    tline2=fgetl(fid);
    fclose(fid); 
    time(i,1)=str2num(tline)/2;
    data(i,1)=str2num(tline2);
end
%%%%%%%%%%%% 前保留後不保留
my_dir_2='data/33/m005/xx/';
...
for i=1:20
    ...
    data(i,4)=str2num(tline2);
end
%%%%%%%%%%%%%%%%%
my_dir_2='data/33/m015/';
temp2=dir([my_dir_2,'*.txt']);
for i=1:20
    filename=[my_dir_2,temp2(i).name];
    fid=fopen(filename,'r+');
